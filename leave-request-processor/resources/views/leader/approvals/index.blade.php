    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                <h3 class="text-xl font-semibold mb-6">Persetujuan Pengajuan Cuti - {{ $division->name ?? 'Divisi' }}</h3>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 text-sm">
                                    <a href="{{ route('leader.approvals.show', $leave) }}" class="text-indigo-600 hover:text-indigo-900">Tinjau</a>
                                </td>
                            </tr>
                            @empty
                            <tr>
                                <td colspan="5" class="px-6 py-4 text-center text-gray-500">Tidak ada pengajuan cuti.</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
